#!/bin/bash
#SBATCH  -J bmmclainMPCY1W1Y2W2add       # job name
...
cd /project/meisel/users/bmmclain/Y1W1Y2W2add
python MultiProcessingCode_Y1W1Y2W2add_v1.py $SLURM_JOB_ID 1000000 1000 48 random

#module add R

#Rscript Graph_Y1W1Y2W2.R $SLURM_JOB_ID